...
inline Status DB::GetApproximateSizes(ColumnFamilyHandle* column_family,
  ...
  options.include_memtables = ((include_flags & SizeApproximationFlags::INCLUDE_MEMTABLES) != SizeApproximationFlags::NONE);
  options.include_files = ((include_flags & SizeApproximationFlags::INCLUDE_FILES) != SizeApproximationFlags::NONE);
  options.include_blob_files = ((include_flags & SizeApproximationFlags::INCLUDE_BLOB_FILES) != SizeApproximationFlags::NONE);
